...
suite('OlafAdapter Integration Tests', () => {
    ...
    function setupBundleStructureMocks(options: {
        ...
        skillManifests?: Record<
            string,
            {
                name: string;
                version?: string;
                entry_points: Array<{ protocol: string; path: string; patterns: string[] }>;
            }
        >;
        skillFiles?: Record<
            string,
            Array<{ name: string; type: 'file' | 'dir'; download_url?: string }>
        >;
    }) {
                    ...
                    'skills/code-review': [
                        {
                            ...
                            type: 'file',
                            download_url:
                                'https://raw.githubusercontent.com/test-owner/test-olaf-repo/main/skills/code-review/manifest.json',
                        },
            ...
            setupBundleStructureMocks({
                bundleDefinitions: [
                    {
                        ...
                        skills: [
                            ...
                            },
                            {
                                ...
                                manifest: 'skills/refactor/manifest.json',
                            },
                        ],
                    },
                    {
                ...
                skillManifests: {
                    'skills/code-review/manifest.json': {
                        name: 'Code Review',
                        entry_points: [
                            { protocol: 'Act', path: '/prompts/review.md', patterns: ['review'] },
                        ],
                    },
                    'skills/refactor/manifest.json': {
                        name: 'Refactor',
                        entry_points: [
                            {
                                protocol: 'Act',
                    ...
                    'skills/data-analysis/manifest.json': {
                        name: 'Data Analysis',
                        entry_points: [
                            { protocol: 'Act', path: '/prompts/analyze.md', patterns: ['analyze'] },
                        ],
                    },
                },
                skillFiles: {
                    ...
                    'skills/refactor': [
                        {
                            ...
                            type: 'file',
                            download_url:
                                'https://raw.githubusercontent.com/test-owner/test-olaf-repo/main/skills/refactor/manifest.json',
                        },
                    ],
                    'skills/data-analysis': [
                        {
                            ...
                            type: 'file',
                            download_url:
                                'https://raw.githubusercontent.com/test-owner/test-olaf-repo/main/skills/data-analysis/manifest.json',
                        },
                    ],
                },
            });
    ...
    suite('Bundle Packaging', () => {
        test('should generate deployment manifest for bundle', async () => {
                ...
                skillFiles: {
                    'skills/data-analysis': [
                        ...
                        },
                        {
                            ...
                            type: 'file',
                            download_url:
                                'https://raw.githubusercontent.com/test-owner/test-olaf-repo/main/skills/data-analysis/main.py',
                        },
                    ],
                },
            });
            ...
            assert.deepStrictEqual(bundles[0].tags, [
                'olaf',
                'skill',
                'data',
                'analysis',
                ...
                .reply(200, [
                    {
                        ...
                        type: 'file',
                        download_url:
                            'https://raw.githubusercontent.com/test-owner/test-olaf-repo/main/bundles/developer.json',
                    },
                    {
                        name: 'analyst.json',
                        ...
                        type: 'file',
                        download_url:
                            'https://raw.githubusercontent.com/test-owner/test-olaf-repo/main/bundles/analyst.json',
                    },
                ])
    ...
    suite('Post-Installation', () => {
        test('should register skill in competency index after installation', async () => {
            ...
            nock('https://api.github.com')
                ...
                .reply(200, [
                    {
                        ...
                        path: 'bundles/test-skill.json',
                        type: 'file',
                        download_url:
                            'https://raw.githubusercontent.com/test-owner/test-olaf-repo/main/bundles/test-skill.json',
                    },
                ])
                ...
                .reply(200, [
                    {
                        name: 'manifest.json',
                        path: 'skills/test-skill/manifest.json',
                        type: 'file',
                        download_url:
                            'https://raw.githubusercontent.com/test-owner/test-olaf-repo/main/skills/test-skill/manifest.json',
                    },
                ])
            ...
            assert.strictEqual(
                writtenData[0].file,
                'external-skills/Test OLAF Source/test-skill/prompts/test-skill.md'
            );
        ...
        test('should update existing skill entry in competency index', async () => {
            ...
            readFileSyncStub
                .withArgs(sinon.match(/competency-index\.json$/), 'utf-8')
    ...
    suite('Post-Uninstallation', () => {
        test('should remove skill from competency index after uninstallation', async () => {
            ...
            assert.strictEqual(
                writtenData[0].file,
                'external-skills/other-source/other-skill/prompts/other-skill.md'
            );
        ...
        test('should handle empty competency index after removing last skill', async () => {
            ...
            assert.strictEqual(
                writtenData.length,
                0,
                'Should be empty after removing the only skill'
            );
        });
        ...
        test('should handle non-existent competency index gracefully', async () => {
            ...
            assert.ok(
                writeFileSyncStub.notCalled,
                'Should not attempt to write when file does not exist'
            );
        });
