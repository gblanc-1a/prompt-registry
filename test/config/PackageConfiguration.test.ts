    ...
    suite('Configuration Schema Structure', () => {
        test('should have configuration section', () => {
            ...
            assert.ok(
                ...
                'contributes should have configuration section'
            );
            assert.ok(
                packageJson.contributes.configuration.properties,
                'configuration should have properties'
            );
        });
        ...
        test('should have updateCheck.enabled setting', () => {
            ...
            assert.strictEqual(
                setting.type,
                'boolean',
                'updateCheck.enabled should be boolean type'
            );
        ...
        test('should have updateCheck.frequency setting', () => {
            ...
            assert.strictEqual(
                setting.type,
                'string',
                'updateCheck.frequency should be string type'
            );
        ...
        test('should have updateCheck.notificationPreference setting', () => {
            ...
            assert.strictEqual(
                setting.type,
                'string',
                'updateCheck.notificationPreference should be string type'
            );
            assert.ok(
                setting.description,
                'updateCheck.notificationPreference should have description'
            );
        });
        ...
        test('should have updateCheck.autoUpdate setting', () => {
            ...
            assert.strictEqual(
                setting.type,
                'boolean',
                'updateCheck.autoUpdate should be boolean type'
            );
    ...
    suite('Default Values', () => {
        ...
        test('updateCheck.frequency should default to "daily"', () => {
            ...
            assert.strictEqual(
                setting.default,
                'daily',
                'updateCheck.frequency should default to "daily"'
            );
        });
        ...
        test('updateCheck.notificationPreference should default to "all"', () => {
            ...
            assert.strictEqual(
                setting.default,
                'all',
                'updateCheck.notificationPreference should default to "all"'
            );
        });
        ...
        test('updateCheck.autoUpdate should default to false', () => {
            ...
            assert.strictEqual(
                setting.default,
                false,
                'updateCheck.autoUpdate should default to false'
            );
        });
    });
    ...
    suite('Enum Options', () => {
        test('updateCheck.frequency should have correct enum values', () => {
            ...
            assert.strictEqual(
                setting.enum.length,
                3,
                'updateCheck.frequency should have 3 enum values'
            );
        ...
        test('updateCheck.notificationPreference should have correct enum values', () => {
            ...
            assert.ok(
                ...
                'updateCheck.notificationPreference should have enum array'
            );
            assert.strictEqual(
                setting.enum.length,
                3,
                'updateCheck.notificationPreference should have 3 enum values'
            );
