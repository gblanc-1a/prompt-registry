...
suite('Hub Types - TDD Implementation', () => {
    suite('validateHubReference', () => {
        ...
        test('should reject path traversal in local paths', () => {
            ...
            assert.throws(() => validateHubReference(ref), /Path traversal detected/);
        });
        ...
        test('should reject non-HTTPS URLs', () => {
            ...
            assert.throws(() => validateHubReference(ref), /Only HTTPS URLs are allowed/);
        });
        ...
        test('should reject invalid GitHub format', () => {
            ...
            assert.throws(() => validateHubReference(ref), /Invalid GitHub repository format/);
        });
        ...
        test('should reject empty location', () => {
            ...
            assert.throws(() => validateHubReference(ref), /Location cannot be empty/);
        });
    ...
    suite('sanitizeHubId', () => {
        ...
        test('should reject IDs with slashes', () => {
            ...
            assert.throws(() => sanitizeHubId(String.raw`hub\id`), /Invalid hub ID/);
        });
    ...
    suite('Security tests - malicious inputs', () => {
        ...
        test('should reject config with path traversal in source ID', () => {
            ...
            assert.strictEqual(result.valid, false);
            assert.ok(
                result.errors.some((e: string) => e.includes('path traversal') || e.includes('../'))
            );
        });
        ...
        test('should reject config with path traversal in bundle ID', () => {
            ...
            assert.strictEqual(result.valid, false);
            assert.ok(
                result.errors.some((e: string) => e.includes('traversal') || e.includes('../'))
            );
        });
    });
});
