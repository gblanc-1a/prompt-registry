...
export interface SyncHistoryEntry {
    ...
    changes: {
        ...
        updated: Array<{ id: string; oldVersion: string; newVersion: string }>;
        removed: string[];
...
export class HubSyncHistory {
    private historyMap: Map<string, SyncHistoryEntry[]> = new Map();

    constructor(private hubManager: HubManager) {}
