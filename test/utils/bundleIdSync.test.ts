...
suite('Bundle ID Synchronization', () => {
    ...
    const bundleIdJs = require(
        path.join(process.cwd(), 'templates/scaffolds/github/scripts/lib/bundle-id.js')
    );
    ...
    const testCases = [
        ...
        {
            repoSlug: 'user/repo-with-dashes',
            collectionId: 'collection-with-dashes',
            version: '10.20.30',
        },
    ];
