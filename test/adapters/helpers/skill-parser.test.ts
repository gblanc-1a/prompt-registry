...
import { calculateContentHash, formatSkillVersion, mapSkillToBundle, parseSkillMd } from '../../../src/adapters/helpers/skill-parser';
import type { SkillItem } from '../../../src/types/skills';
...
suite('skill-parser', () => {
  ...
  suite('mapSkillToBundle()', () => {
    test('maps SkillItem to Bundle', () => {
      const skill: SkillItem = { id: 'my-skill', name: 'My Skill', description: 'great', license: 'MIT', path: 'skills/my-skill', skillMdPath: 'skills/my-skill/SKILL.md', files: ['SKILL.md', 'h.ts'], contentHash: 'abc123def456abc123def456abc123def456abc123def456abc123def456abc1' };
