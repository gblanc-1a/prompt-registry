...
This file is typically generated by an automated workflow (GitHub Actions) that harvests reactions from GitHub Discussions. See the [Engagement Guide](../user-guide/engagement.md) for details on setting up automated harvesting.
