...
export class BundleBuilder {
  private readonly bundle: Partial<Bundle> = {
 ...
 * @param mockRegistryManager
 * @param mockShowQuickPick
 * @param mockShowInformationMessage
 * @param mockWithProgress
 */
