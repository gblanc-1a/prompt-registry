...
const { readCollection, resolveCollectionItemPaths } = require('./lib/collections');
const { generateBundleId } = require('./lib/bundle-id');
...
async function createZip({ repoRoot, zipPath, manifestPath, itemPaths }) {
  ...
  // Using 1980-01-01 ensures identical zip checksums across runs regardless of
  // when the build occurs. This is critical for CI caching and artifact verification.
