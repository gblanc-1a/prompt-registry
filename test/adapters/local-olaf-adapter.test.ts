...
import {
  LocalOlafAdapter,
} from '../../src/adapters/local-olaf-adapter';
import {
  RegistrySource,
...
suite('LocalOlafAdapter', () => {
  ...
  suite('competency index path consistency', () => {
    ...
    test('should use consistent paths for installation and uninstallation', async () => {
      ...
      const originalEnsureRuntimeInstalled = adapterAny.ensureRuntimeInstalled;
      const originalCreateWorkspaceLinks = adapterAny.createWorkspaceLinks;
      const originalCreateSkillSymbolicLinks = adapterAny.createSkillSymbolicLinks;
      const originalRemoveSkillSymbolicLinks = adapterAny.removeSkillSymbolicLinks;

      adapterAny.ensureRuntimeInstalled = async () => { /* mock - do nothing */ };
      adapterAny.createWorkspaceLinks = async () => { /* mock - do nothing */ };
      adapterAny.createSkillSymbolicLinks = async () => { /* mock - do nothing */ };
      adapterAny.removeSkillSymbolicLinks = async () => { /* mock - do nothing */ };
      ...
      try {
        ...
        adapterAny.ensureRuntimeInstalled = originalEnsureRuntimeInstalled;
        adapterAny.createWorkspaceLinks = originalCreateWorkspaceLinks;
        adapterAny.createSkillSymbolicLinks = originalCreateSkillSymbolicLinks;
        adapterAny.removeSkillSymbolicLinks = originalRemoveSkillSymbolicLinks;
