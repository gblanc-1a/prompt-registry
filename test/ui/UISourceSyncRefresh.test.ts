...
suite('UI Source Sync Refresh', () => {
    ...
    suite('Debouncing Logic', () => {
        test('should debounce single event correctly', (done) => {
            ...
            const events: SourceSyncedEvent[] = [{ sourceId: 'test-source', bundleCount: 5 }];
            ...
            setTimeout(() => {
                assert.strictEqual(
                    refreshCallback.callCount,
                    1,
                    'Should call refresh once after debounce'
                );
                done();
            }, 600);
        });
    ...
    suite('Event Data Structure', () => {
        ...
        test('should include bundleCount in event', () => {
            ...
            assert.ok(
                typeof event.bundleCount === 'number',
                'Event should include bundleCount as number'
            );
