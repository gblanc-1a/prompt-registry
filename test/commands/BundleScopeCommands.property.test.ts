...
import { BundleScopeCommands, ContextMenuAction } from '../../src/commands/BundleScopeCommands';
...
suite('BundleScopeCommands Property Tests', () => {
    ...
    setup(() => {
        ...
        mockUserScopeService = sandbox.createStubInstance(UserScopeService);
