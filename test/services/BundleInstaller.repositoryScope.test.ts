...
import { Bundle, InstallOptions, InstalledBundle, InstallationScope } from '../../src/types/registry';
import { IScopeService, ScopeStatus } from '../../src/services/IScopeService';
